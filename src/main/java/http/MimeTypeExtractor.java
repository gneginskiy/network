...
public class MimeTypeExtractor {
            ...
            Collections.unmodifiableMap(new HashMap<String, String>() {
                {
                    ...
                    put(".obj", "application/octet-stream");
                    ...
                    put(".si", "text/vnd.wap.si");
                    put(".sic", "application/vnd.wap.sic");
                    ...
                    put(".sl", "text/vnd.wap.sl");
                    put(".slc", "application/vnd.wap.slc");
                    ...
                    put(".swi", "application/vnd.arastra.swi");
    ...
    public static String getMimeType(String filename, String requestMessage) {
        int dotIndex = StringUtils.lastIndexOf(filename, ".");
        return dotIndex > -1 ?
                conversionMap.getOrDefault(filename.substring(dotIndex), "text/html") :
                extractMimeFromRequest(requestMessage);
    }
